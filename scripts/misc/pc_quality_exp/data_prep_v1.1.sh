...
# PC Quality Filter Experiment - Data Preparation v1.1
# Species: Athaliana + Osativa (high quality, multiple epochs equivalent)
# Generated from: make -f pipelines/training -n all SPECIES_IDS="Athaliana Osativa" RUN_VERSION=v1.1

set -euo pipefail

echo "Starting PC Quality Filter Experiment - Data Preparation v1.1"
echo "Species: Athaliana + Osativa"
...
EXTRACT_DIR="$PIPE_DIR/extract/v1.1"
TRANSFORM_DIR="$PIPE_DIR/transform/v1.1"
PREP_DIR="$PIPE_DIR/prep/v1.1"
...
echo "$(date): Data preparation v1.1 completed successfully!"
