...
# Training data paths (Arabidopsis)
RAW_GFF_DIR="/workdir/zl843/GeneCAD/fine-tuning/genome/Arabidopsis"
RAW_FASTA_DIR="/workdir/zl843/GeneCAD/fine-tuning/genome/Arabidopsis"
SPECIES_IDS="Athaliana"

# Pipeline directories
WORK_DIR="/workdir/zl843/GeneCAD/genecad_result"
PIPELINE_DIR="$WORK_DIR/training_emarro_ar"
...
NUM_WORKERS=4
VALID_PROPORTION=0.025

# Output
OUTPUT_DIR="$PIPELINE_DIR/training_output"
RUN_NAME="emarro-ar-athaliana-v1"
...
# Check and link Arabidopsis files
GFF_FILE="$RAW_GFF_DIR/Athaliana_Chr1_4.gff3"
FASTA_FILE="$RAW_FASTA_DIR/Athaliana_Chr1_4.fa"
...
ln -sf "$GFF_FILE" "$DATA_DIR/gff/Athaliana_447_Araport11.gene.gff3" 2>/dev/null || true
ln -sf "$FASTA_FILE" "$DATA_DIR/fasta/Athaliana_447.fasta" 2>/dev/null || true

echo "  GFF:   $GFF_FILE -> $DATA_DIR/gff/Athaliana_447_Araport11.gene.gff3"
echo "  FASTA: $FASTA_FILE -> $DATA_DIR/fasta/Athaliana_447.fasta"
