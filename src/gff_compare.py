...
def run_gffcompare(reference_path: str, input_path: str, output_dir: str, gffcompare_path: str) -> str:
        ...
        for line in lines:
            ...
            if table_start and 'level:' in line and '|' in line:
                ...
                if len(values) == 2:
                    ...
                    raise ValueError(f"Expected exactly 2 numeric values for sensitivity and precision, but found {len(values)} in line: {line.strip()}")
