...
# =================================================================
# Usage: ./run_genecad_prediction.sh
# =================================================================

# 1. Configuration
# ----------------
INPUT_FILE="/workdir/zl843/GeneCAD/fine-tuning/genome/Arabidopsis/original/Athaliana_447_TAIR10.fa"
OUTPUT_DIR="/workdir/zl843/GeneCAD/genecad_result/prediction_emarro_ar_chr5"
SPECIES_ID="Athaliana"
CHR_ID="chr5"       # Target Chromosome ID in output
INPUT_CHR="Chr5"    # Source Chromosome ID in FASTA header

# Model Paths
# Using the new baseline model as per recent integration
BASE_MODEL="/workdir/zl843/GeneCAD/pcad2-200M-cnet-ar"
HEAD_MODEL="/workdir/zl843/GeneCAD/genecad_result/training_emarro_ar/training_output/checkpoints/last.ckpt"

# Pipeline Config
TOKENIZER_PATH="$BASE_MODEL" # Use the same model for tokenization
BATCH_SIZE=32
DTYPE="bfloat16"
# Both precision-leaning (require UTRs) and recall-leaning (no UTRs required) outputs will be generated
...
echo "================================================================="
echo "Running GeneCAD Prediction Pipeline"
